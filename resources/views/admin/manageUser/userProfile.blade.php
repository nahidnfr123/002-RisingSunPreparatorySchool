...
@php  $subPageName = 'Profile'  @endphp
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" method="Post"
                          action=" @if(\Illuminate\Support\Facades\Auth::user()->roles->pluck('name')->first() == 'Super Admin') {{ route('admin.profile.update.super')}} @endif">
                        @csrf
